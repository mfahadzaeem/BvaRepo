...
A purple label means that **you** need to take some further action.  
 - ![Not Actionable - Need Info](http://angular-ui.github.io/ui-router/img/notactionable.png): Your issue is not specific enough, or there is no clear action that we can take. Please clarify and refine your issue.
 - ![Plunkr Please](http://angular-ui.github.io/ui-router/img/plunkrplease.png): Please [create a plunkr](http://bit.ly/UIR-Plunk)
 - ![StackOverflow](http://angular-ui.github.io/ui-router/img/stackoverflow.png): We suspect your issue is really a help request, or could be answered by the community.  Please ask your question on [StackOverflow](http://stackoverflow.com/questions/ask?tags=angularjs,angular-ui-router).  If you determine that is an actual issue, please explain why.
